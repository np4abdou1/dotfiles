...
KCM.SimpleKCM {
    ...
    QtObject {
        id: iconsSide_Settings
        property int size
    }
    property string cfg_icon: plasmoid.configuration.icon
    property bool cfg_useCustomButtonImage: plasmoid.configuration.useCustomButtonImage
    property string cfg_customButtonImage: plasmoid.configuration.customButtonImage
    property alias cfg_forceColor: forceColorConfigs.checked
    property alias cfg_showFavoritesFirst: iconsSide_Settings.size


    property alias cfg_labels2lines: labels2lines.checked
    property alias cfg_displayPosition: displayPosition.currentIndex
    property alias cfg_sizeSideIcons: iconsSide_Settings.size
    ...
    Kirigami.FormLayout {
        ...
        CheckBox {
            id: forceColorConfigs
            Kirigami.FormData.label: i18n("Force color of side icons")
        }
        ...
        ComboBox {
            ...
            Kirigami.FormData.label: i18n("Side Icons Size:")
            id: sizeSideIcons
            textRole: "text"
            valueRole: "value"
            visible: true
            ...
            onActivated: iconsSide_Settings.size = currentValue
            Component.onCompleted: currentIndex = indexOfValue(iconsSide_Settings.size)
        }
